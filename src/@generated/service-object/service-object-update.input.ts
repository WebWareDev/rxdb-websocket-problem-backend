...
import { ServicePlanUpdateOneRequiredWithoutService_objectNestedInput } from '../service-plan/service-plan-update-one-required-without-service-object-nested.input';

@InputType()
export class ServiceObjectUpdateInput {
    ...
    @Field(() => ServicePlanUpdateOneRequiredWithoutService_objectNestedInput, {nullable:true})
    service_plan?: ServicePlanUpdateOneRequiredWithoutService_objectNestedInput;
}
